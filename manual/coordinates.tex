...
particle beam using the \vn{global} coordinate system so, for each tracking lattice branch,
...
\vn{machine} and \vn{global} coordinate systems is described in \sref{s:global}. Non-tracking branches
...
between the entrance and exit frames is parallel to the $y$-axis (\sref{s:global}). 
