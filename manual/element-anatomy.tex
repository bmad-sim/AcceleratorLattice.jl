...
The values of \vn{pdict} will, with a few exceptions, be a parameter group.
By convention, the key used for storing a parameter group in \vn{pdict} is the symbol associated with the type. For example, a \vn{LengthGroup} would be stored in \vn{pdict[:LengthGroup]}.
